      ...
      <div className="container-max">
        <div className="text-center mb-16">
          ...
          <p className="text-[18px] leading-8 text-gray-700 max-w-4xl mx-auto">
            נעים להכיר, אני אורלי. יועצת עסקית ורואת חשבון מוסמכת עם מעל 20 שנות
            ניסיון, מלווה בעלי עסקים—בעיקר נותני שירות, מטפלים ומאמנים—לסדר
            פיננסי, צמיחה עסקית ותודעתית. חשוב לי לראות את האדם מאחורי העסק,
            ולבנות יחד תהליך שהוא גם פרקטי וגם מרגיע.
          </p>
        </div>
