          ...
          <div className="container-max">
            ...
            <div className="space-y-12">
              ...
              <div className="card p-8">
                ...
                <p className="text-[18px] leading-8 text-[var(--ink)] mb-6">
                  אתה יוצא מהשיחה עם בהירות מלאה על המצב הנוכחי, הבנה של מה חוסם
                  אותך, ותוכנית פעולה פשוטה וברורה לצעד הבא. לא בירוקרטיה, לא
                  מונחים מורכבים – רק בהירות ותוכנית שקל לך לעמוד בה.
                </p>
