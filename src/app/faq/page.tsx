            ...
            mainEntity: [
              {
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "בשיחה הראשונה אנחנו נכיר, אני אבין איפה אתה נמצא מבחינה עסקית ופיננסית, ואנחנו נחליט יחד על הכיוון הנכון עבורך. אתה יוצא עם בהירות על המצב הנוכחי ועל הצעדים הבאים.",
                },
              },
              {
                "@type": "Question",
                ...
                acceptedAnswer: {
                  "@type": "Answer",
                  text: "אני משלבת בין שני התחומים. סדר פיננסי בלבד לא מספיק – צריך גם לעבוד על התודעה והאמונות שמשפיעות על ההחלטות שלך. השילוב בין מספרים לתודעה הוא מה שיוצר תוצאות אמיתיות.",
                },
              },
              {
                "@type": "Question",
            ...
            <div className="space-y-8">
              <div className="card p-8">
                ...
                <p className="text-[18px] leading-8 text-[var(--ink)]">
                  ...
                  ופיננסית, ואנחנו נחליט יחד על הכיוון הנכון עבורך. אתה יוצא עם
                  בהירות על המצב הנוכחי ועל הצעדים הבאים.
                </p>
              </div>
              ...
              <div className="card p-8">
                ...
                <p className="text-[18px] leading-8 text-[var(--ink)]">
                  אני משלבת בין שני התחומים. סדר פיננסי בלבד לא מספיק – צריך גם
